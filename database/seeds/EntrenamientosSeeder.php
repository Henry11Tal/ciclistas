...
class EntrenamientosSeeder extends Seeder
{
    public function run(): void
    {
        DB::table('ciclista')->insert([
            ['nombre'=>'Juan','apellidos'=>'Pérez','fecha_nacimiento'=>'1990-05-10','peso_base'=>70.5,'altura_base'=>175,'email'=>'test1@prueba.com','password'=>'prueba'],
            ['nombre'=>'Ana','apellidos'=>'Rodríguez','fecha_nacimiento'=>'1992-08-20','peso_base'=>60.0,'altura_base'=>165,'email'=>'test2@prueba.com','password'=>'prueba'],
            ['nombre'=>'Pedro','apellidos'=>'García','fecha_nacimiento'=>'1995-03-15','peso_base'=>80.0,'altura_base'=>180,'email'=>'test3@prueba.com','password'=>'prueba'],
            ['nombre'=>'Carmen','apellidos'=>'García','fecha_nacimiento'=>'1998-09-05','peso_base'=>55.0,'altura_base'=>160,'email'=>'test4@prueba.com','password'=>'prueba'],
            ['nombre'=>'Luis','apellidos'=>'Rodríguez','fecha_nacimiento'=>'1972-09-15','peso_base'=>62.0,'altura_base'=>170,'email'=>'test5@prueba.com','password'=>'prueba'],
            ['nombre'=>'Maria','apellidos'=>'Rodríguez','fecha_nacimiento'=>'1972-09-15','peso_base'=>62.0,'altura_base'=>170,'email'=>'test6@prueba.com','password'=>'prueba'],
            ['nombre'=>'Ricardo','apellidos'=>'García','fecha_nacimiento'=>'1982-09-15','peso_base'=>72.0,'altura_base'=>170,'email'=>'test7@prueba.com','password'=>'prueba'],
        ]);
        ...
        DB::table('bloque_entrenamiento')->insert([
            ['nombre'=>'Calentamiento','descripcion'=>'Rodaje suave progresivo','tipo'=>'rodaje','duracion_estimada'=>'00:15:00','potencia_pct_min'=>55,'potencia_pct_max'=>65,'pulso_pct_max'=>70,'pulso_reserva_pct'=>50,'comentario'=>'Subir pulsaciones gradualmente'],
            ['nombre'=>'Rodaje Z2','descripcion'=>'Resistencia aeróbica','tipo'=>'rodaje','duracion_estimada'=>'01:00:00','potencia_pct_min'=>65,'potencia_pct_max'=>75,'pulso_pct_max'=>80,'pulso_reserva_pct'=>65,'comentario'=>'Base aeróbica'],
            ['nombre'=>'Sweet Spot 8 min','descripcion'=>'Intervalos Sweet Spot','tipo'=>'intervalos','duracion_estimada'=>'00:08:00','potencia_pct_min'=>88,'potencia_pct_max'=>94,'pulso_pct_max'=>90,'pulso_reserva_pct'=>80,'comentario'=>'Trabajo de umbral submáximo'],
            ['nombre'=>'Recuperación','descripcion'=>'Pedaleo muy suave','tipo'=>'recuperacion','duracion_estimada'=>'00:05:00','potencia_pct_min'=>45,'potencia_pct_max'=>55,'pulso_pct_max'=>65,'pulso_reserva_pct'=>45,'comentario'=>'Eliminar fatiga'],
        ...
        DB::table('entrenamiento')->insert([
            ['id_ciclista'=>1,'id_bicicleta'=>1,'fecha'=>'2026-01-01 07:30:00','duracion'=>'01:45:00','kilometros'=>55.2,'recorrido'=>'Ruta Valle','pulso_medio'=>140,'pulso_max'=>170,'potencia_media'=>200,'potencia_normalizada'=>210,'velocidad_media'=>31.5,'puntos_estres_tss'=>60.5,'factor_intensidad_if'=>0.88,'ascenso_metros'=>800,'comentario'=>'Buen ritmo matutino'],
